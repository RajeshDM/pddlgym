(define (problem solitaire-instance)
  (:domain solitaire)
  (:objects
    c5s2 c6s2 c7s2 c7s1 c8s1 c9s1 c3s0 c5s1 c6s1 c1s1 c2s1 c3s1 c4s1 c0s1 c1s0 c9s0 c6s0 c8s0 c0s0 c5s0 c2s0 c4s0 c9s3 c2s3 c3s3 c4s3 c5s3 c6s3 c7s3 c8s3 c7s0 c8s2 c9s2 c0s3 c1s3 c0s2 c1s2 c2s2 c3s2 c4s2  - card 
