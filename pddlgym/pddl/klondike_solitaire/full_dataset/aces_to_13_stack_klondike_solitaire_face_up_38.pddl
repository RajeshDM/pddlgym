(define (problem solitaire-instance)
  (:domain solitaire)
  (:objects
    c10s1 c11s1 c12s1 c9s2 c10s2 c11s2 c12s2 c0s3 c0s1 c1s1 c2s1 c3s1 c4s1 c10s0 c11s0 c12s0 c5s1 c6s1 c6s0 c7s0 c8s0 c5s0 c9s0 c3s0 c4s0 c2s0 c1s0 c0s0 c1s3 c2s3 c3s3 c4s3 c5s3 c6s3 c7s3 c8s3 c9s3 c10s3 c11s3 c12s3 c0s2 c1s2 c2s2 c3s2 c4s2 c5s2 c6s2 c7s2 c8s2 c7s1 c8s1 c9s1  - card 
 foundation0 foundation1 foundation2 foundation3 tableau0 tableau1 tableau2 tableau3 tableau4 tableau5 tableau6 - pile
  ...
  (:init
    ...
    (on_pile c10s1 tableau0)
    (in_tab_pile c10s1)
    (is_free_card c10s1)
    (is_moveable c10s1)
    (on_pile c11s1 tableau1)
    (in_tab_pile c11s1)
    (on_card c12s1 c11s1)
    (in_tab_pile c12s1)
    (is_free_card c12s1)
    (is_moveable c12s1)
    (on_pile c9s2 tableau2)
    (in_tab_pile c9s2)
    (on_card c10s2 c9s2)
    (in_tab_pile c10s2)
    (on_card c11s2 c10s2)
