(define (problem solitaire-instance)
  (:domain solitaire)
  (:objects
    c4s2 c5s2 c0s2 c1s2 c2s2 c1s0 c5s0 c5s1 c3s1 c4s1 c0s0 c2s1 c0s1 c1s1 c0s3 c1s3 c2s3 c3s3 c4s3 c5s3 c2s0 c3s0 c4s0 c3s2  - card 
...
(can_move_on_tab_pile c5s0 tableau0)
(can_move_on_tab_pile c5s0 tableau1)
(can_move_on_tab_pile c5s0 tableau2)
(can_move_on_tab_pile c5s0 tableau3)
(can_move_on_tab_pile c5s0 tableau4)
(can_move_on_tab_pile c5s0 tableau5)
(can_move_on_tab_pile c5s0 tableau6)
(can_move_on_tab_pile c5s1 tableau0)
(can_move_on_tab_pile c5s1 tableau1)
(can_move_on_tab_pile c5s1 tableau2)
(can_move_on_tab_pile c5s1 tableau3)
(can_move_on_tab_pile c5s1 tableau4)
(can_move_on_tab_pile c5s1 tableau5)
(can_move_on_tab_pile c5s1 tableau6)
(can_move_on_tab_pile c5s2 tableau0)
(can_move_on_tab_pile c5s2 tableau1)
(can_move_on_tab_pile c5s2 tableau2)
(can_move_on_tab_pile c5s2 tableau3)
(can_move_on_tab_pile c5s2 tableau4)
(can_move_on_tab_pile c5s2 tableau5)
(can_move_on_tab_pile c5s2 tableau6)
(can_move_on_tab_pile c5s3 tableau0)
(can_move_on_tab_pile c5s3 tableau1)
(can_move_on_tab_pile c5s3 tableau2)
(can_move_on_tab_pile c5s3 tableau3)
(can_move_on_tab_pile c5s3 tableau4)
(can_move_on_tab_pile c5s3 tableau5)
(can_move_on_tab_pile c5s3 tableau6)
