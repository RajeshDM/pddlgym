(define (problem solitaire-instance)
  (:domain solitaire)
  (:objects
    c1s2 c0s3 c1s1 c0s1 c1s0 c0s0 c1s3 c0s2  - card 
...
(can_move_on_tab_pile c1s0 tableau0)
(can_move_on_tab_pile c1s0 tableau1)
(can_move_on_tab_pile c1s0 tableau2)
(can_move_on_tab_pile c1s0 tableau3)
(can_move_on_tab_pile c1s0 tableau4)
(can_move_on_tab_pile c1s0 tableau5)
(can_move_on_tab_pile c1s0 tableau6)
(can_move_on_tab_pile c1s1 tableau0)
(can_move_on_tab_pile c1s1 tableau1)
(can_move_on_tab_pile c1s1 tableau2)
(can_move_on_tab_pile c1s1 tableau3)
(can_move_on_tab_pile c1s1 tableau4)
(can_move_on_tab_pile c1s1 tableau5)
(can_move_on_tab_pile c1s1 tableau6)
(can_move_on_tab_pile c1s2 tableau0)
(can_move_on_tab_pile c1s2 tableau1)
(can_move_on_tab_pile c1s2 tableau2)
(can_move_on_tab_pile c1s2 tableau3)
(can_move_on_tab_pile c1s2 tableau4)
(can_move_on_tab_pile c1s2 tableau5)
(can_move_on_tab_pile c1s2 tableau6)
(can_move_on_tab_pile c1s3 tableau0)
(can_move_on_tab_pile c1s3 tableau1)
(can_move_on_tab_pile c1s3 tableau2)
(can_move_on_tab_pile c1s3 tableau3)
(can_move_on_tab_pile c1s3 tableau4)
(can_move_on_tab_pile c1s3 tableau5)
(can_move_on_tab_pile c1s3 tableau6)
